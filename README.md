...
- 版號升至 `0.1.20260623`；研習／職務年表附件選檔修正後為 `0.1.20260623a` → `0.1.20260623b`（工作地圖圖層強化）→ `0.1.20260623c`（現在位置常駐、儲存修正、底圖開關右下角）→ `0.1.20260623d`（現在位置 HTML Marker、工作地圖預設行政區界線）→ `0.1.20260623e`（工作地圖進入預設精簡、邊界與名稱分離）→ `0.1.20260623f`（推送）。
