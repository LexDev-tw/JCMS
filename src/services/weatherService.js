...
async function getSatelliteLatest(product = 'ir-tw') {
    ...
    const datasetId = datasetByProduct[product] || datasetByProduct['ir-tw'];
    const key = getApiKey();
...
async function fetchSatelliteImageBuffer(product = 'ir-tw') {
